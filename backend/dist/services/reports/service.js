...
exports.getReportData = exports.generatePDFReport = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
const database_1 = require("../../shared/database");
const service_1 = require("../ledger/service");
const generatePDFReport = async (shopId, options) => {
    // 1. Fetch Data
    ...
    const summary = await (0, service_1.getSalesSummary)(shopId, { startDate, endDate });
    const transactions = await database_1.prisma.sale.findMany({
        where: {
            shopId,
            createdAt: {
                gte: startDate,
...
const getReportData = async (shopId, timeframe) => {
    ...
    transactions.forEach(t => {
        ...
        if (t.paymentType in paymentMix) {
            paymentMix[t.paymentType] += amount;
        }
        totalRevenue += amount;
    });
