...
exports.requireShop = void 0;
const ApiError_1 = require("../errors/ApiError");
const ShopService = __importStar(require("../../services/shops/service"));
const requireShop = async (req, res, next) => {
    try {
        ...
        if (!shop) {
            throw new ApiError_1.ApiError(404, 'You must create a shop before managing this resource.');
        }
